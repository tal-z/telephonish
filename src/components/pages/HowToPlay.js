    ...
    <JustifiedContainer alignment={"left"}>
      <div>
        ...
        <ol>
          ...
          <li>
            At the end of the game, players will be shown multi-media
            "slideshows" comparing each player's original prompt with the final
            output to see how it evolved through the game.
          </li>
        </ol>
